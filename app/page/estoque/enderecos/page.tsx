...
function corDaOcupacao(percentual: number): string {
    if (percentual >= 100) return "bg-[#D4351C]"
    if (percentual >= 80) return "bg-[#B25E00]"
    return "bg-[#08A022]"
}
...
export default function EnderecosPage() {
    ...
    return (
        <>
            <main className="min-h-screen bg-[#F0F3F4] text-[#1E2428] md:ml-64 print:hidden">
                ...
                <header className="sticky top-16 z-30 border-b border-[#D3DADD] bg-[#F0F3F4]/95 backdrop-blur md:top-0">
                    ...
                    <div className="flex min-h-20 flex-wrap items-center justify-between gap-4 px-6 md:px-10">
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="mb-8 max-w-2xl">
                            ...
                            <h2 className="font-display text-3xl tracking-tight text-[#1E2428] sm:text-4xl">
                                Os lugares onde a mercadoria fica
                            </h2>

                            <p className="mt-2 text-[#5A6469]">
                                Para que serve cada lugar, quanto cabe nele e se aceita movimentação
                                agora. É por este cadastro que o sistema decide sozinho onde guardar o
                                que entra — e é a placa impressa daqui que diz isso a quem está no
                                corredor.
                            </p>
                        ...
                        {erro && (
                            <div role="alert" className="mb-4 flex items-start gap-2.5 rounded-lg bg-[#FDECEA] px-4 py-3 text-sm font-semibold text-[#D4351C]">
                        ...
                        {aviso && (
                            <div role="status" className="mb-4 flex items-start gap-2.5 rounded-lg bg-[#E0FFEE] px-4 py-3 text-sm font-semibold text-[#08A022]">
                        ...
                        <div className="card grid grid-cols-2 divide-[#E4E9EB] md:grid-cols-4 md:divide-x">
                            ...
                            <Indicador
                                ...
                                cor={totalCheios > 0 ? "bg-[#FFF6E0] text-[#8A6C1B]" : "bg-[#F0F3F4] text-[#5A6469]"}
                                rotulo="Cheios"
                                valor={totalCheios}
                                destaque={totalCheios > 0 ? "text-[#8A6C1B]" : ""}
                            />

                            <Indicador
                                icone={<FiLock className="w-4" aria-hidden />}
                                cor={totalBloqueados > 0 ? "bg-[#FDECEA] text-[#D4351C]" : "bg-[#F0F3F4] text-[#5A6469]"}
                                rotulo="Bloqueados"
                                valor={totalBloqueados}
                                destaque={totalBloqueados > 0 ? "text-[#D4351C]" : ""}
                            />

                        </div>

                        <p className="mt-2 text-xs text-[#5A6469]">
                        ...
                        {selecionados.length > 0 && (
                            ...
                            <div className="mt-4 flex flex-wrap items-center gap-3 rounded-lg border border-[#0086FF] bg-[#E6F3FF] px-4 py-2.5">

                                <p className="text-sm font-bold text-[#0075E2]">
                                    <span className="num">{selecionados.length}</span> endereço(s) marcado(s)
                                </p>

                                <span className="hidden h-5 w-px bg-[#B8D9FB] sm:block" />
                        ...
                        {carregando ? (
                            ...
                            <p className="mt-6 text-[#5A6469]">Carregando endereços...</p>
                            ...
                            <div className="mt-6 rounded-lg border border-dashed border-[#D3DADD] bg-white p-16 text-center">
                                ...
                                <p className="mx-auto mt-2 max-w-md text-sm text-[#5A6469]">
                                    {enderecos.length === 0
                            ...
                            <div className="card mt-6 overflow-hidden">
                                            ...
                                            {daPagina.map((endereco) => {
                                                ...
                                                return (
                                                    ...
                                                    <Fragment key={endereco.id}>
                                                        ...
                                                        <tr className={`border-b border-[#E4E9EB] transition-colors hover:bg-[#F7F9FA] ${marcado ? "bg-[#F5FAFF]" : ""}`}>
                                                            ...
                                                            {/* ENDEREÇO */}
                                                            <td className="px-4 py-2.5">
                                                                <span className="num font-bold text-[#1E2428]">{endereco.codigo}</span>
                                                                {endereco.descricao && (
                                                                    <span className="block max-w-[16rem] truncate text-xs text-[#8C969B]">
                                                                        {endereco.descricao}
                                                                    </span>
                                                                )}
                                                            </td>
                                                            ...
                                                            {/* ONDE FICA */}
                                                            <td className="px-4 py-2.5">
                                                                <span className="block text-[#1E2428]">{endereco.nome}</span>
                                                                <span className="block text-xs text-[#8C969B]">
                                                            ...
                                                            <td className="px-4 py-2.5 text-right">
                                                                ...
                                                                <span className="num font-bold text-[#1E2428]">
                                                                    {endereco.ocupacao}
                                                                    <span className="font-normal text-[#8C969B]">
                                                                        {endereco.capacidade > 0 ? ` / ${endereco.capacidade}` : " / —"}
                                                                    </span>
                                                                </span>

                                                                {typeof endereco.ocupacao_percentual === "number" && (
                                                                    <span className="ml-auto mt-1 block h-1.5 w-24 overflow-hidden rounded-full bg-[#E4E9EB]">
                                                                        <span
                                                            ...
                                                            <td className="px-4 py-2.5">
                                                                ...
                                                                {endereco.bloqueado && endereco.motivo_bloqueio && (
                                                                    <span className="mt-1 block max-w-[14rem] truncate text-xs text-[#D4351C]">
                                                                ...
                                                                <div className="flex items-center justify-end gap-1">
                                                                    ...
                                                                    {endereco.bloqueado ? (
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="flex h-8 w-8 items-center justify-center rounded-md border border-[#D3DADD] text-[#08A022] transition-colors hover:border-[#08A022] hover:bg-[#E0FFEE]"
                                                                        >
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="flex h-8 w-8 items-center justify-center rounded-md border border-[#D3DADD] text-[#5A6469] transition-colors hover:border-[#D4351C] hover:bg-[#FDECEA] hover:text-[#D4351C]"
                                                                        >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className={`flex h-8 w-8 items-center justify-center rounded-md border transition-colors ${
                                                                            marcado
                                                                                ? "border-[#0086FF] bg-[#E6F3FF] text-[#0075E2]"
                                                                                : "border-[#D3DADD] text-[#5A6469] hover:border-[#0086FF] hover:bg-[#E6F3FF] hover:text-[#0075E2]"
                                                                        }`}
                                                                    >
                                                                        <FiPrinter className="w-4" aria-hidden />
                                                                    </button>
                                                        ...
                                                        {bloqueando === endereco.id && !endereco.bloqueado && (
                                                            ...
                                                            <tr className="border-b border-[#E4E9EB] bg-[#F7F9FA]">
                                ...
                                <div className="flex flex-col gap-3 border-t border-[#D3DADD] bg-[#F7F9FA] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <p className="text-xs text-[#5A6469]">
                                        ...
                                        de <span className="num font-bold text-[#1E2428]">{ordenados.length}</span>
...
function Indicador({
    ...
    return (
        <div className={`flex items-center gap-3 p-4 ${borda ? "border-b border-[#E4E9EB] md:border-b-0" : ""}`}>
            ...
            <span className="min-w-0">
                <span className="block text-xs text-[#5A6469]">{rotulo}</span>
                <span className={`num block text-xl font-extrabold ${destaque || "text-[#1E2428]"}`}>{valor}</span>
            </span>
        ...
        <Painel titulo="Montar a estrutura" aoFechar={aoFechar}>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="flex gap-4 pt-1.5">
                        {LADOS.map((opcao) => (
                            <label key={opcao} className="flex cursor-pointer items-center gap-2 text-sm text-[#1E2428]">
                                <input
                                    type="checkbox"
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg bg-[#F0F3F4] p-4">
                ...
                <p className="text-sm text-[#1E2428]">
                    ...
                    <span className="text-[#5A6469]">Os que já existirem ficam como estão.</span>
                </p>
    ...
    return (
        <section className="card mt-6 space-y-5 p-5 sm:p-7">
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <h3 className="font-display text-base text-[#1E2428]">{titulo}</h3>

                <button
                    type="button"
                    onClick={aoFechar}
                    aria-label="Fechar"
                    className="flex h-8 w-8 items-center justify-center rounded-md text-[#5A6469] transition-colors hover:bg-[#F0F3F4]"
                >
                    <FiX className="w-4" aria-hidden />
                </button>
